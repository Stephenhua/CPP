...
int Core(int startx, int starty,int endx,int endy,int num){
    ...
    if(check(startx,starty,arr)){
        arr[startx][starty] = 1;
        num = Core(startx+1,starty,endx,endy,num+1) + Core(startx-1,starty,endx,endy,num+1) + Core(startx,starty-1,endx,endy,num+1) + Core(startx,starty+1,endx,endy，num+1)+1;
        arr[startx][starty] = 0;
    }
    return num;
}*/
